...
import { normalizePersonGroups } from "../model/normalizers";
...
export function useOrganization(apiFetch) {
  ...
  async function loadOrganization() {
    ...
    if (groupResult.status === "fulfilled") {
      personGroups.value = normalizePersonGroups(groupResult.value);
    }
  ...
  async function refreshPersonGroups() {
    personGroups.value = normalizePersonGroups(await apiFetch("/api/organization/person-groups/"));
  }
